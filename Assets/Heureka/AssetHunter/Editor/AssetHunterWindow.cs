...
public class AssetHunterWindow : EditorWindow, ISerializationCallbackReceiver
{
    ...
    private static AssetHunterWindow m_window;
    private Vector2 scrollPos;

    //TODO MAKE SURE THIS IS SERIALIZEd
    ...
    private static AssetHunterWindow doInit()
    {
        m_window = EditorWindow.GetWindow<AssetHunterWindow>();
        m_window.Show();

        EditorUtils.SetWindowValues(m_window, AssetDatabase.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterLogoSmall.png", typeof(Texture)) as Texture, "Asset Hunter");
        m_window.m_UIWarning = AssetDatabase.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterWarning.png", typeof(Texture2D)) as Texture2D;
        m_window.m_UIWideLogo = AssetDatabase.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterLogoWide.png", typeof(Texture2D)) as Texture2D;
        m_window.m_UIAchievementIcon = AssetDatabase.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterAchievementUnlocked.png", typeof(Texture2D)) as Texture2D;
        m_window.m_UISceneSelect = AssetDatabase.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterSceneSelect.png", typeof(Texture2D)) as Texture2D;
        m_window.m_UIFolderSelect = AssetDatabase.LoadAssetAtPath("Assets/Heureka/AssetHunter/Editor/UI/AssetHunterFolderSelect.png", typeof(Texture2D)) as Texture2D;
    ...
    private void showBuildAssetInfoUI()
    {
        ...
        for (int i = 0; i < m_BuildLog.AssetCount; i++)
        {
            if (m_usedTypeDict[m_BuildLog.GetAssetAtIndex(i).Type] == true)
            {
                ...
                GUILayout.Space(10);
                if (GUILayout.Button(m_UISceneSelect, GUIStyle.none, GUILayout.Width(imageSize), GUILayout.Height(imageSize)))
                {
                    ...
                    //TODO Write something to the user here
                }
                GUILayout.Space(10);

                if (GUILayout.Button(m_UIFolderSelect, GUIStyle.none, GUILayout.Width(imageSize), GUILayout.Height(imageSize)))
                {
                ...
                GUILayout.Label(EditorGUIUtility.ObjectContent(null, asset.Type.SystemType).image, GUILayout.Width(imageSize), GUILayout.Height(imageSize));
                GUILayout.FlexibleSpace();
                EditorGUILayout.EndHorizontal();
    ...
    public static AssetHunterWindow Instance
    {
        get {
            if (m_window != null)
                return m_window;
